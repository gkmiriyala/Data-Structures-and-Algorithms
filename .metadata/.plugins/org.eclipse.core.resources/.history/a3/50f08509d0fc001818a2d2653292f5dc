...
public class StringsPractice {
	public static void main(String[] args) {
		...
		System.out.print(strAllUniqueNoDataStruct("yhap"));
	}
	...
	public static boolean strPermutation(String sOne, String sTwo) {
		...
		for (int i = 0; i < sOne.length(); i++) {
			if (!map.containsKey(sOne.charAt(i)))
				...
				map.put(sOne.charAt(i), map.get(sOne.charAt(i)) + 1);
		}
	...
	/*
	 * Find all distinct palindromic substrings of a given string. Input:
	 * “abaaa” Output: Below are 5 palindrome sub-strings a, aa, aaa, aba, b
	 */
	...
	/*
	 * Return whether a given String is a palindrome or not Use Recursion
	 */
	...
	/*
	 * Return the minimum number of characters to add to a String to make it a
	 * palindrome
	 */
	 ...
	 */
	public static boolean strAllUnique(String s) {
		HashMap<Character, Integer> map = new HashMap<Character, Integer>();
		for (int i = 0; i < s.length(); i++) {
	 ...
	 */
	public static boolean strAllUniqueNoDataStruct(String s) {
		for (int i = 0; i < s.length(); i++) {
